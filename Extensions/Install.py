...
from Products.UserField.config import PROJECTNAME
from Products.UserField.config import product_globals as GLOBALS

def install(self, reinstall=False):
    """ External Method to install UserField """
    out = StringIO()
    ...
    try:
        from Products.UserField.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    from Products.UserField.config import STYLESHEETS
    try:
        ...
        pass
    from Products.UserField.config import JAVASCRIPTS
    try:
